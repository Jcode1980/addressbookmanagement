...
public class AddressBookController {
    ...
    public Collection<ContactDto> getContactsFromAddressBook(@ApiParam(value="The id of the address book which holds all the contacts") @PathVariable("addressBookID")String addressBookID) throws IllegalArgumentException {
    ...
    @PostMapping(value = "/addressBook/addContact{addressBookID}", consumes="application/json", produces="application/json")
